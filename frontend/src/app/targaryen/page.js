    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-800 text-white">
      ...
      <section className="relative bg-black py-20 px-5 flex flex-col items-center text-center">
        ...
        <div className="w-1/2 mt-10">
          <ImgCarousel images={['/w8d.webp','/w10.webp', '/w6.webp', '/w3.webp']} imageOptions={{ priority: true }} />
        </div>
      </section>
      ...
      <SectionCard
        ...
        images={[ '/ec1.jpg', '/ec2.webp', '/ec.jpg', '/d1.jpg', '/ec3.avif']}
      ...
      <SectionCard
        ...
        images={['/w5.webp', '/tiffany.jpeg', '/term.jpg', '/me4u.jpg', '/starwar.avif', '/marvel.jpg' ]}
      ...
      <SectionCard
        ...
        images={['/w7.webp', '/w1.webp', '/w2.webp']}
...
Make morally complex decisions that often pit mercy against justice.`]}
      ...
      <SectionCard
        ...
        images={['/all.jpg', '/w10.webp', '/throne.jpg']}
